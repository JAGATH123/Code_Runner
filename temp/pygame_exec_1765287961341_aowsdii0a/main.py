...
while running:
    ...
    # Draw text labels ABOVE the bars
    fuel_label = font.render("Fuel:", True, (255, 255, 255))
    oxygen_label = font.render("Oxygen:", True, (255, 255, 255))
    
    screen.blit(fuel_label, (10, 430))   # Text 20px above bar
    screen.blit(oxygen_label, (10, 490)) # Text 20px above bar
    ...
    # Draw bars at specified positions
    pygame.draw.rect(screen, fuel_color, (50, 450, fuel * 4, 20))
    pygame.draw.rect(screen, oxygen_color, (50, 510, oxygen * 4, 20))
