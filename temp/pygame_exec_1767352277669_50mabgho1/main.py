...
while running:
    ...
    altitude_text = font.render(f"Altitude: {altitude} m", True, (255, 255, 255))
    
    screen.blit(speed_text, (600, 450))
    screen.blit(altitude_text, (600, 480))
    
    pygame.display.flip()
    await asyncio.sleep(0)
    
    if not printed:
        print("Status information rendered")
        printed = True
