...
export function Header() {
  ...
  useEffect(() => {
    ...
    if (pathname.includes('/11-14') || pathname === '/missions' || pathname.includes('/introduction')) {
      // Apply blue theme for 11-14 age group pages, missions page, and introduction pages
  ...
  // Apply black text on problem pages and introduction pages with earth theme
  const useBlackText = isEarthTheme && (pathname?.includes('/problems/') || pathname?.includes('/introduction'));
